...
class TestPropertiesFIleResource(TestCase):
  ...
  def test_action_create_empty_properties_without_dir(self,
    ...
    create_file_mock.assert_called_with('/somewhere_in_system/one_file.properties', '# Generated by Apache Ambari. Today is Wednesday\n    \n    ', encoding="UTF-8", on_file_created=ANY)
  ...
  def test_action_create_empty_properties_with_dir(self,
    ...
    create_file_mock.assert_called_with('/dir/and/dir/file.txt', '# Generated by Apache Ambari. Some other day\n    \n    ', encoding="UTF-8", on_file_created=ANY)
    ensure_mock.assert_called()
  ...
  def test_action_create_properties_simple(self,
    ...
    create_file_mock.assert_called_with('/dir/new_file', '# Generated by Apache Ambari. 777\n    \nproperty1=value1\n    ', encoding="UTF-8", on_file_created=ANY)
    ensure_mock.assert_called()
  ...
  def test_action_create_properties_rewrite_content(self,
    ...
    create_file_mock.assert_called_with('/dir1/new_file', '# Generated by Apache Ambari. 777\n    \nproperty_1=value1\n    ', encoding="UTF-8", on_file_created=ANY)
    ensure_mock.assert_called()
